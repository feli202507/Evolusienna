...
st.write("!Ingat! Informasi kamu ga akan tersimpan kalo kamu keluar ya...")
...
with manual : 
    ...
    3. Tulis semua pemahaman kamu sebanyak-banyaknya. Dengan menulis, kamu bisa seolah-olah berada di ruang kelas
    lagi nulis jawaban kalian di kertas ujian.
    4. Setelah selesai, review hasilnya dengan catatan kamu yg tadi dibaca. Gapapa kalo ga semua yg penting ketulis.
    5. Pakai pulpen warna lain, mulai koreksi dan tambahin informasi yg kelewat dan kamu lupa.
    6. Pahami dan ingat kembali informasi yang kamu lupain tadi. Artinya kamu perlu fokus kesitu
    7. Kalau ada waktu, ulang sampe kamu ingat semua materi dan udah dapet "feel" nya buat ngerjain ujian
    """)
...
with st.expander("⌛️ Klik disini buat tips dan hal pentingnya") :
    ...
    2. Jangan kebiasaan "ngintip" catatannya saat kamu udah stuck. Akui kamu stuck dan tinggal 
    tambahin informasi itu saat kamu koreksi. Jangan ngerasa gamau salah.
...
with online:
    ...
    with col_1 :
        st.subheader("Informasi yg kamu ingat")
        ingat = st.text_area("Ketik semua yg kamu sudah pelajari",height=400)
    ...
    if st.button("Finish") :
        st.success("Yey! Selesai! Sekarang buka buku dan koreksi yaa!!")
        st.snow()
