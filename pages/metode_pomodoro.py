...
#LOGO
st.image("assets/panda_logo.png",width=150)
#PENJELASAN
...
st.write("""
    ...
    Setelah 1 sesi, kamu boleh istirahat 5 menit. Setelah 4 sesi, kamu boleh istirahat panjang!!
""")
#CARA PAKAI
...
3. **Kerjain tugas sampe timer kamu bunyi**
4. **Istirahat 5 menit**
...
with st.expander("🍅Klik disini untuk tipsnya!!") :
    ...
    2. Silent hp kamu, matiin notif semua sosmed
